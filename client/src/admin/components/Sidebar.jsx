  ...
  return (
    <div className="Sidebar">
      <aside
        ...
        className={`fixed top-0 left-0 z-40 w-60 h-screen py-12 bg-white border-r border-gray-200 transition-transform transform ${
          isSidebarOpen ? "translate-x-0" : "-translate-x-full"
        } lg:translate-x-0 xl:translate-x-0 dark:bg-gray-800 dark:border-gray-700`}
      >
        <div className="h-full px-6 py-8 overflow-y-auto bg-white dark:bg-gray-800">
          <ul className="space-y-4 font-medium">
            <li>
              <Link to="/dashboard" className={`flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group ${location.pathname === "/dashboard" && "bg-gray-100 dark:bg-gray-700"}`}>
            ...
            <li>
              <Link to="/data-mitra" className={`flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group ${location.pathname === "/data-mitra" && "bg-gray-100 dark:bg-gray-700"}`}>
            ...
            <li>
              ...
              >
                ...
                {isDropdownOpen1 ? <ChevronUp className="text-gray-700 ms-12" size={20} strokeWidth={2} /> : <ChevronDown className="text-gray-700 ms-12" size={20} strokeWidth={2} />}
              </button>
              {isDropdownOpen1 && (
                <ul id="dropdown-example" className="pt-4 space-y-4">
                  <li>
                    <Link
                      to="/data-webinar"
                      className={`flex font-secondary text-sm items-center w-full p-2 py-3 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700 ${
                        location.pathname === "/data-webinar" && "bg-gray-100 dark:bg-gray-700"
                      }`}
                    >
                      Webinar
                    </Link>
                  ...
                  <li>
                    <Link
                      to="/data-komunitas"
                      className={`flex font-secondary text-sm items-center w-full p-2 py-3 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700 ${
                        location.pathname === "/data-komunitas" && "bg-gray-100 dark:bg-gray-700"
                      }`}
                    >
                      Komunitas
                    </Link>
            ...
            <li>
              <Link to="/data-artikel" className={`flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group ${location.pathname === "/data-artikel" && "bg-gray-100 dark:bg-gray-700"}`}>
          ...
          <div className="absolute bottom-5 w-48">
            <button onClick={logout} className="flex items-center p-2 px-3 bg-red-700 text-white rounded-lg dark:text-white hover:bg-red-800 dark:hover:bg-gray-700 group">
