...
function EditWebinar() {
    ...
    useEffect(() => {
        axios.get(`http://localhost:3001/webinar/${id}`)
            .then(res => {
                console.log('Response:', res);
                const responseData = res.data;
                if (responseData) {
                    setValues({ ...values, judul: responseData.judul, foto: responseData.foto, deskripsi: responseData.deskripsi, narasumber: responseData.narasumber, tanggal: responseData.tanggal, waktu: responseData.waktu, harga: responseData.harga, link_daftar: responseData.link_daftar });
                } else {
                ...
                <form onSubmit={handleUpdate}>
                    <div className="grid gap-4 grid-cols-2 lg:grid-cols-6 sm:gap-6">
                        ...
                        <Input
                            ...
                            name="waktu"
                            type="time"
                            placeholder="Masukkan waktu webinar"
                            value={values.waktu}
