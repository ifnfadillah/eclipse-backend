            ...
            {[
              ...
              <div key={index} className="mb-8">
                <h3 id={`accordion-collapse-heading-${index}`}>
                  <button
                    type="button"
                    className={`flex items-center justify-between w-full p-6 font-primary font-medium md:text-xl lg:text-2xl text-left bg-white border-b-0 shadow-lg transition-colors duration-300 ${
